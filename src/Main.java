...
//fájlkezelő
        ...
        JMenuItem item1 = new JMenuItem(newp);
            ...
            item1.setFont(new Font("Segoe UI Emoji", Font.PLAIN, 22));
        ...
        JMenuItem item2 = new JMenuItem(newf);
            ...
            item2.setFont(new Font("Segoe UI Emoji", Font.PLAIN, 22));
        ...
        JMenuItem item3 = new JMenuItem(openp);
            ...
            item3.setFont(new Font("Segoe UI Emoji", Font.PLAIN, 22));
        ...
        JMenuItem item4 = new JMenuItem(mainp);
            ...
            item4.setFont(new Font("Segoe UI Emoji", Font.PLAIN, 22));
